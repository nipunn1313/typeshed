...
class ReprEntry(TerminalRepr):
    ...
    reprfileloc: Any = ...
    style: Any = ...
    def __init__(self, lines: Sequence[str], reprfuncargs: Optional[ReprFuncArgs], reprlocals: Optional[ReprLocals], filelocrepr: Optional[ReprFileLocation], style: _TracebackStyle) -> None: ...
    def toterminal(self, tw: TerminalWriter) -> None: ...
